...
public class KeyPairCreate {
	public static void main(String[] args) {
		try {
			...
			File publicKeyFile = createKeyFile(new File("E:/AppChat/publicKey.rsa"));
			File privateKeyFile = createKeyFile(new File("E:/AppChat/privateKey.rsa"));
